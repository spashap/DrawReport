...
Run: venv/Scripts/python.exe scripts/render_gallery.py [palette]
  palette: "" (Golden Hour, default) | pu | dk | cl
Output: component-gallery.html in project root — open in a browser to confirm the
palette + 7-step scale + components match Golos.
"""
import sys
...
def main() -> None:
    ...
    print(f"OK: {out}  (palette: {palette or 'Golden Hour default'})")
