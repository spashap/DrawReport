# Positioning & copy brief — DrawReport (English)

**Status: this is the messaging *intent* + a first DRAFT. The owner will refine final wording on the
...
- H1 (hook = the mechanism): «Дети часто говорят рисунками о том, о чём не всегда могут сказать словами.»
- Lead (what you get): «**Поймите, что выражает ваш ребёнок:** мы покажем, в чём он силён, что стоит
  развивать и как поддержать его дома — опираясь на этапы развития детского рисунка.»
- CTA: «Получить отчёт — <price>»

## Messaging rules (learned the hard way — keep them)
1. **Hook = the why/mechanism, stated plainly:** *kids express through drawing what they can't yet say
   in words → we read it for you.* This answers a cold visitor's "what is this / why do I care" instantly.
   Brand poetry ("every drawing has a voice") is a small eyebrow, NOT the explanation.
2. **No filler adjectives in the hook.** "Warm / heartfelt personal report" does not make anyone buy —
   it wastes the most valuable line. Cut it.
3. **No negatives in the hook.** "No diagnoses / no scary interpretations" is a conversion killer up top.
...
"Voice of the drawing" is the poetic thread; the substance is development and support.
